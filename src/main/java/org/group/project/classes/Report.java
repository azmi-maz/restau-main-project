...
public class Report {
    ...
    private static final String REPORT_INFO = "No.%s, %s, %s %s";
    private static final String DEFAULT_REPORT = "Report no. %d"
    ...
    public int getNewReportId() throws TextFileNotFoundException {
        try {
            ...
            int reportIdIndex = DataFileStructure
                    .getIndexColOfUniqueId(REPORT_FILE);
    ...
    public String getGeneratedOnDateForDatabase() {
        return getGeneratedOnDate().format(
                DateTimeFormatter.ofPattern(DATE_FORMAT_DATABASE));
    }
