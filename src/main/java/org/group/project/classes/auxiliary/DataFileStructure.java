...
public enum DataFileStructure {
        ...
        TABLES("tableName",
                        Arrays.asList("tableName", "numOfSeats", "base-imageurl", "table-status",
                                        "height-sub", "height-div", "width-sub", "width-div",
                                        "colIdx", "rowIdx", "colSpan", "rowSpan").toArray(new String[0])),
        ...
        MENU("itemName",
                        Arrays.asList("itemName", "itemType", "isDailySpecial", "imageurl",
                                        "height-sub", "height-div", "width-sub", "width-div",
                                        "colIdx", "rowIdx", "colSpan", "rowSpan", "imgAlign",
                                        "tagAlign", "stackAlign", "maxHeight", "maxWidth").toArray(new String[0])),
        PRESET_ITEMS("itemName",
                        Arrays.asList("itemName", "itemType", "isDailySpecial", "imageurl",
                                        "height-sub", "height-div", "width-sub", "width-div",
                                        "colIdx", "rowIdx", "colSpan", "rowSpan", "imgAlign",
                                        "tagAlign", "stackAlign", "maxHeight", "maxWidth").toArray(new String[0])),
        ...
        ORDERS("orderId",
                        Arrays.asList("orderId", "userId", "orderDate", "orderTime",
                                        ...
                                        "assignedDriver", "deliveryTime", "orderedLists").toArray(new String[0])),
        REPORTS("reportId",
                        Arrays.asList("reportId", "reportType", "generatedBy",
                                        "generatedOnDate", "generatedOnTime", "reportData").toArray(new String[0]));
