...
public class CustomerBookingTablesNavbarController {

        private static final String UNDO_BUTTON = "undo";
        private static final String RESERVATION_BUTTON = "history";
        ...
        @FXML
        private Button bookingsHistoryButton;
        ...
        public void initialize() {
                ...
                ImageLoader.setUpGraphicButton(bookingsHistoryButton,
                ...
                returnButton.setOnMousePressed(e -> {
                        ...
                        TablesView.controller.resetsBookingForm();
                        TablesView.controller.clearGrid();
                });

                bookingsHistoryButton.setOnMousePressed(e -> {
